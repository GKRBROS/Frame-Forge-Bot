...
function createSupabaseClient() {
  ...
  // We check both VITE_ and non-VITE_ variations as provided in Vercel
  ...
  if (!SUPABASE_URL || !SUPABASE_PUBLISHABLE_KEY) {
    ...
    const message = `Missing Supabase environment variable(s): ${missing.join(', ')}. Please check your Vercel environment variables.`;
